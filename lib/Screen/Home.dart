...
import 'package:eshopmultivendor/Screen/Estimate.dart';
import 'package:eshopmultivendor/Screen/OrderList.dart';
import 'package:eshopmultivendor/Screen/ProductList.dart';
import 'package:eshopmultivendor/Screen/RequestDetails.dart';
...
//============================= initState Method ===============================
  ...
  submitRequest() async {
    ...
    var headers = {
      'Cookie': 'ci_session=78da4e5abce81d56494a8f7bdc296895ddc9826e'
    };
    var request =
        http.MultipartRequest('POST', Uri.parse(baseUrl + 'get_seller_requst'));
    request.fields.addAll({
      'seller_id': CUR_USERID.toString(),
    });
    ...
    if (response.statusCode == 200) {
      ...
      final finalResponse = RequestModel.fromJson(json.decode(jsonResponse));
      setState(() {
        requestData = finalResponse;
      });
    } else {
...
//=============================== chart coding  ================================
  ...
  requestPage() {
    print("777777777777777777object");
    return requestData == null || requestData == ""
        ...
        : ListView.builder(
            shrinkWrap: true,
            itemCount: requestData!.data!.length, //original file ma joe levu
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => RequestScreen(
                               model: requestData,
                              id: requestData!.data![i].reqId.toString()
                            )));
                  },
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => UploadCustomer(),
            ),
          );
        },
        child: Card(
