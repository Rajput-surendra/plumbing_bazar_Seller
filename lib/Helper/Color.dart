...
const Color primary =Color(0xff01ADEF);
const Color secondary = Color(0xff01ADEF);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xff01ADEF);
const Color grad2Color = Color(0xff01ADEF);
